...
public class PersistenceTests {
    ...
    private int getDatabaseRows() {
        int rows = 0;
        try {
            Class<?> clazz = Class.forName("dataAccess.dataAccess.DatabaseManager");
            ...
            Assertions.fail("Unable to load database in order to verify persistence. Are you using dataAccess.dataAccess.DatabaseManager to set your credentials?");
        }
